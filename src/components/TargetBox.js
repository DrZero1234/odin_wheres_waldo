...
export default function TargetBox({x,y,setx,sety,characters,setclicked, clicked, targetXPercent, targetYPercent}) {
  const style = {
  ...
  const handleMouseClicked = (event) => {
    ...
    console.log(targetXPercent);
    console.log(targetYPercent)
